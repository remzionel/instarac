...
const questionTools = [
  {
    ...
    choices:
      [
        ...
        "[8]  Follow Followers Target by People - No Comment",
        "[9]  Follow Followers Target by People - No Comment & Like",
        "[10]  Repost Media Target by People",
        "[11] Repost Media Target by Hashtag",
        "[12] Repost Media Target by Link",
        "[13] Comment & Like Followers Target by People",
        "[14] Comment & Like Followers Target by Hashtag",
        "[15] Bom Like Target's Post",
        "[16] Bom Comment Target's Post",
        "[17] Unfollow Not Followback",
        "[18] Unfollow All Following",
        "[19] Delete All Media",
        ""
      ] 
  }
  ...
  try{
    ...
    switch(toolChoise){
      ...
      case "[7]  Follow Followers Target by People - No Like":
        ...
        break;
      case "[8]  Follow Followers Target by People - No Comment":
        await require("./src/FFTPeople-noComment.js");
        break;
      case "[9]  Follow Followers Target by People - No Comment & Like":
      ...
      case "[12] Repost Media Target by Link":
        ...
        break;
      case "[13] Comment & Like Followers Target by People":
        await require("./src/commentLike-byPeople.js");
        break;
      case "[14] Comment & Like Followers Target by Hashtag":
        await require("./src/commentLike-byHashtag.js");
        break;
      case "[15] Bom Like Target's Post":
        await require("./src/bomLike.js");
        break;
      case "[16] Bom Comment Target's Post":
        await require("./src/bomComment.js");
        break;
      case "[17] Unfollow Not Followback":
        await require("./src/unfollowNotFollowBack.js");
        break;
      case "[18] Unfollow All Following":
        await require("./src/unfollowAllFollowing.js");
        break;
      case "[19] Delete All Media":
